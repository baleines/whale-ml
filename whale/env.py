...
class Env(object):
    ...
    def __init__(self, config):
        ...
        if self.single_agent_mode:
            ...
            # If at least one pre-trained agent needs raw data
            #     set self.allow_raw_data = True
    ...
    def set_agents(self, agents):
        ...
        if self.single_agent_mode:
            raise ValueError(
                'Setting agent in single agent or human mode is not allowed.')

        self.agents = agents
        # If at least one agent needs raw data, set self.allow_raw_data = True
    ...
    def get_perfect_information(self):
        ...
        Returns:
            (dict): Dictionary of all perfect information of current state
    ...
    def _extract_state(self, state):
        ''' Extract information from state for RL. Must be implemented in child class.
